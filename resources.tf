...
# call ansible to setup instance
      ...
      provisioner "local-exec" {
        command = "ANSIBLE_HOST_KEY_CHECKING=False ansible-playbook -u ec2-user --private-key /var/lib/jenkins/secrets/new-key.pem -i '${self.public_ip},' unbound_setup.yml"
      }
}
